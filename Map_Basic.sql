...
CREATE TABLE `wind_data` (
  ...
  `mast` VARCHAR NULL DEFAULT NULL,
  `direction` DOUBLE NULL DEFAULT NULL,
  `mast_coordinates` GEOMETRY NULL DEFAULT NULL,
